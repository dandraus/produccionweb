        ...
        return (
            ...
            <div style={{ maxWidth: '100%' }}>
                ...
                <Dialog open={this.state.open} onClose={handleClose.bind(this)} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title">Crear Maquina</DialogTitle>
                    <DialogContent>
...
function eliminar(nuevodato) {
    ...
    axios.delete(process.env.REACT_APP_URL_LARAVEL+`/api/Maquina/${nuevodato.id}`)
        .then(res => {
...
function actualizar(nuevodato) {
    ...
    axios.put(process.env.REACT_APP_URL_LARAVEL+`/api/Maquina/${nuevodato.id}`, nuevodato)
        .then(res => {
...
function guardar(event) {
    ...
    const datoGuardar = {
        ...
        descripcion: this.state.formControls.descripcion.value,
       
    };
    console.log(datoGuardar);
    console.log(this.state);

    axios.post(process.env.REACT_APP_URL_LARAVEL+`/api/Maquina`, (datoGuardar))
        .then(res => {
