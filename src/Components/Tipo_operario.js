...
function eliminar(nuevodato) {
    ...
    axios.delete(`http://dashroute.test/api/tipo_operario/${nuevodato.id}`)
        .then(res => {
...
function actualizar(nuevodato) {
    ...
    axios.put(`http://dashroute.test/api/tipo_operario/${nuevodato.id}`, nuevodato)
        .then(res => {
...
function guardar(event) {
    ...
    axios.post(`http://dashroute.test/api/tipo_operario`, tipo)
        .then(res => {
