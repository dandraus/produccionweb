...
class Tipo_unidades extends Component {
    state = {
        datos: [],
        open: false,
        Sopen: false,
        ...
        return (
            ...
            <div style={{ maxWidth: '100%' }}>
                ...
                <Dialog open={this.state.open} onClose={handleClose.bind(this)} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title">Nuevo tipo de unidad</DialogTitle>
                    <DialogContent>
                        <DialogContentText>
                            Caracterizar los tipo de unidades, ejemplo mts3
          </DialogContentText>
                        <TextField
                        ...
                        />
                         <TextField
                            value={this.state.categoria} onChange={this.handleChange.bind(this)}
                            autoFocus
                            margin="dense"
                            id="categoria"
                            label="Categoria"
...
function eliminar(nuevodato) {
    ...
    axios.delete(`http://dashroute.test/api/tipo_unidades/${nuevodato.id}`)
        .then(res => {
...
function actualizar(nuevodato) {
    ...
    axios.put(`http://dashroute.test/api/tipo_unidades/${nuevodato.id}`, nuevodato)
        .then(res => {
...
function guardar(event) {
    ...
    const datoGuardar = {
        ...
        categoria:this.state.formControls.categoria.value
    };
    console.log(datoGuardar);
   
    axios.post(`http://dashroute.test/api/tipo_unidades`, (  datoGuardar ))
        .then(res => {
