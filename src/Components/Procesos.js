...
class Procesos extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(process.env.REACT_APP_URL_LARAVEL+`/api/Procesos`)
            .then(res => {
        ...
        return (
            ...
            <div style={{ maxWidth: '100%' }}>
                ...
                <Dialog open={this.state.open} onClose={handleClose.bind(this)} aria-labelledby="form-dialog-title">
                    <DialogTitle id="form-dialog-title">Crear Proceso</DialogTitle>
                    <DialogContent>
...
function eliminar(nuevodato) {
    ...
    axios.delete(process.env.REACT_APP_URL_LARAVEL+`/api/Procesos/${nuevodato.id}`)
        .then(res => {
...
function actualizar(nuevodato) {
    ...
    axios.put(process.env.REACT_APP_URL_LARAVEL+`/api/Procesos/${nuevodato.id}`, nuevodato)
        .then(res => {
...
function guardar(event) {
    ...
    axios.post(process.env.REACT_APP_URL_LARAVEL+`/api/Procesos`, (datoGuardar))
        .then(res => {
